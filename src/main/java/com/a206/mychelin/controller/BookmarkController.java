...
public class BookmarkController {
    ...
    @GetMapping("/places")
    public ResponseEntity<CustomResponseEntity> getPlaceBookmarks(HttpServletRequest httpServletRequest) {
        return bookmarkService.getPlaceBookmarks(httpServletRequest);
    }

    @ApiOperation(value = "사용자가 저장한 맛집 리스트에 대한 북마크")
    @GetMapping("/lists")
    public ResponseEntity<CustomResponseEntity> getPlaceListBookmarks(HttpServletRequest httpServletRequest) {
    ...
    @PutMapping("/places")
    public ResponseEntity<CustomResponseEntity> addPlaceBookmark(@RequestBody Bookmark.PlaceRequest placeRequest, HttpServletRequest httpServletRequest) {
    ...
    @PutMapping("/lists")
    public ResponseEntity<CustomResponseEntity> addPlaceListBookmark(@RequestBody Bookmark.PlaceListRequest placeListRequest, HttpServletRequest httpServletRequest) {
